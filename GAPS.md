...
### G71 — a library-defined type is freed shallowly: no deep drop is synthesized
...
### G72 — a closure environment is freed shallowly: every capture leaks
...
### G73 — a named binding unused in one arm of a lifted closure is never released
